...
function setup() {
  ...
  scene.addImage("fundo",backgroundImage);
  scene.scale = 2.5
  
  // criando arco para atirar flecha
  bow = createSprite(380,220,20,50);
  bow.addImage("arco",bowImage); 
  bow.scale = 1;
...
// Criando flechas para arco
 ...
 function redBalloon() {
   ...
   red.addImage("balão",red_balloonImage);
   red.velocityX = 3;
   red.lifetime = 150;
   red.scale = 0.1;
 }
...
function blueBalloon() {
  ...
  blue.addImage("balão",blue_balloonImage);
  blue.velocityX = 3;
  blue.lifetime = 150;
  blue.scale = 0.1;
}
...
function greenBalloon() {
  ...
  green.addImage("balão",green_balloonImage);
  green.velocityX = 3;
  green.lifetime = 150;
  green.scale = 0.1;
}
...
function pinkBalloon() {
  ...
  pink.addImage("balão",pink_balloonImage);
  pink.velocityX = 3;
  pink.lifetime = 150;
  pink.scale = 1;
}
